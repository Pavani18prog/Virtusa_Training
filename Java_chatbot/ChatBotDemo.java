			...
			public void actionPerformed(ActionEvent e){
				if(e.getSource()==b){
					...
					if(text.contains("Hi")) {
						...
						replyMeth("Ram Nath Kovind");
					}
					else if(text.contains("Vice president of india")){	
						replyMeth("M.Venkaiah Naidu");
					}
						...
						replyMeth("Edappadi Karuppa Palaniswami");
					}
					else if(text.contains("Educational minister of tamilnadu")){	
						replyMeth("K.A.Sengotttaiyan");
					}
						...
						replyMeth("Buggal Ragendranath Reddy");
					}
